<template>
  <section class="hero" :style="{ backgroundImage: `url(${heroImages[currentHero]})` }">
    <div class="hero-mask">
      ...
      <div class="hero-actions">
        <el-button type="warning" size="large" @click="router.push('/hot')">阅读热门图文</el-button>
        <el-button plain size="large" @click="router.push('/notes')">进入游记专区</el-button>
      </div>
    </div>
  </section>
  ...
  <section class="section-block">
    <div class="title-row-between">
      <h2>热门景点推荐</h2>
      <el-link type="primary" @click="router.push('/hot')">查看全部</el-link>
    </div>
  ...
  <section class="section-block">
    <div class="title-row-between">
      <h2>精选游记</h2>
      <el-link type="primary" @click="router.push('/notes')">进入游记专区</el-link>
    </div>
    <div class="notes-grid">
...
const featuredHotArticles = computed(() => hotArticles.slice(0, 3))
