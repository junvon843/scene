...
export const travelNotes = [
  {
    ...
    scenicId: 2,
    title: '在弧湾看一场奶油橘日落',
    excerpt: '从码头到悬崖步道，整条线都像电影场景，尤其是傍晚海风和夕阳叠加的瞬间。',
    author: '星野旅人',
    views: 12890,
    ...
    location: '华南·蔚蓝弧湾秘境岛',
    sections: [
      { heading: '出发前准备', text: '这条线路最舒服的节奏是 2 天 1 夜，白天拍海岸线，傍晚抓落日，夜里住在靠海露台酒店。建议提前一周订船票与岛上接驳车。', image: localImage2 },
      { heading: '步道与机位', text: '从南码头步行到弧湾观景台约 40 分钟，途中有三段礁石观景点。第二段平台是我最推荐的拍摄位，逆光下海浪层次非常明显。', image: localImage1 },
      { heading: '落日时段', text: '18:10 左右天空会出现橘粉渐变，最后 12 分钟是黄金窗口。建议提前布机，人物拍摄时让模特背向海面，会得到更干净的轮廓线。', image: localImage5 }
    ],
    ...
    longBody: [
      '这条海岛线路最大的优点是节奏舒适，几乎没有强制赶路的压力。把拍摄重心放在傍晚和清晨，你会同时拿到柔和暖光和清透冷光两套风格，内容呈现更完整。',
      '岛上的商业化不算重，仍然保留了不少自然海岸线。建议把时间留给步道与观景台，不要把行程排满。慢下来后，你会发现海风、浪声和光线变化本身就是最好的旅行体验。'
    ]
  },
  {
    id: 102,
    scenicId: 1,
    title: '雪谷轻徒步 6 小时全记录',
    excerpt: '路线难度友好，关键点位和拍摄机位都整理好了，新手也能拍出高级大片。',
    author: '林间慢行',
    views: 9876,
    ...
    location: '西南·霞慕尼云镜雪谷',
    sections: [
      { heading: '徒步节奏', text: '全线约 13 公里，海拔缓升，不追求速度。每 2 公里安排一次补水，真正累的是后半段风口，建议带一件轻量保暖外套。', image: localImage4 },
      { heading: '高光时刻', text: '清晨 7 点左右在木桥上等待第一束光，雪脊会被点亮。这个机位拍人像和风景都很稳，容错率非常高。', image: localImage3 },
      { heading: '返程建议', text: '回程不要走原路，换到北侧林线小道，光影更柔和，人也少。结束后在山口咖啡馆休整，能看到整个峡谷全景。', image: localImage2 }
    ],
  ...
  },
  {
    id: 104,
    scenicId: 5,
    title: '摩登城市 48 小时轻奢路线',
    excerpt: '观景台、展览、天台餐厅一条龙，时间紧也能玩得很高级。',
    author: '舟行万里',
    views: 8450,
    ...
    location: '华东·云端摩登天际城',
    sections: [
      { heading: 'Day 1 城市纵线', text: '上午直达观景台，下午逛艺术街区，晚上预约天台餐厅。这样安排可以同时拿到白天与夜晚两组城市光线。', image: localImage2 },
  ...
  },
  {
    ...
    scenicId: 3,
    title: '镜湖秋色最美三段步道',
    excerpt: '晨雾时段、红叶下午光和傍晚倒影，三段时间拍摄风格完全不同。',
    author: '木舟',
    views: 11230,
    ...
    location: '华东·镜湖森林秘语谷',
    sections: [
      { heading: '晨雾机位', text: '6:20 前到湖东步道，能抓到最轻薄的一层雾。这个时段的色调偏蓝，后期轻微提暖就很高级。', image: localImage3 },
      { heading: '红叶下午光', text: '14:30 到 16:00 的侧光最适合拍树冠层次，建议压低机位让步道线条延伸到画面深处。', image: localImage4 },
      { heading: '倒影收尾', text: '日落后 20 分钟水面最平静，慢门拍摄会把红叶与远山融合成油画感。', image: localImage1 }
    ],
    gear: ['ND 滤镜', '快门线', '防潮垫'],
  ...
  },
  {
    ...
    scenicId: 6,
    title: '荒野露营与银河延时入门',
    excerpt: '从设备准备到参数设置，第一次拍银河也能有作品。',
    author: '北屿',
    views: 7650,
    ...
    location: '西北·大漠星河秘境线',
    sections: [
      { heading: '营地搭建', text: '优先选背风沙丘后方，地面平整且远离车道光污染。帐篷入口朝东，便于凌晨收光时快速撤离。', image: localImage4 },
      { heading: '银河参数', text: '首拍建议用 14mm、f/2.8、20s、ISO 3200，先确保银河可见，再逐步优化前景亮度。', image: localImage5 },
      { heading: '安全与补给', text: '夜里温差很大，热饮和保暖层要充足。拍摄结束后先检查器材再休息，防止沙尘进入卡口。', image: localImage2 }
    ],
    ...
    longBody: [
      ...
      '如果是第一次拍星空，不要贪多。先稳定拿到 1-2 张清晰银河图，再尝试前景叠加和延时。循序渐进会让你的作品质量提升更快。'
    ]
  }
]
